			...
			<div className='grid md:grid-cols-2 md:items-center'>
				...
				<div className='px-6 pt-11 pb-[52px] md:px-10 lg:px-20 lg:py-[100px] xl:py-[200px] xl:px-[90px]'>
					<div className='md:max-w-[518px]'>
						<TypographyH3 className='leading-[1.4] text-center md:text-left rtl:md:text-right'>
							{t("title")}
						</TypographyH3>
						<p className='mt-8 text-xl tracking-[0.2px] font-medium leading-normal text-center md:text-left rtl:md:text-right'>
							{t("description")}
						</p>
					</div>
				</div>
