...
export default async function DevelopmentAutomationSection() {
	const t = await getTranslations("CasesPage.devAutomation")
	...
	return (
		<section className='py-12 md:py-20' id='development-automation'>
