			...
			{items.map((item, index) => {
				...
				return (
					<button
						...
						type='button'
						className={cn(
							"relative flex items-center h-[408px] w-[300px] px-[34px] pt-[226px] pb-7 transition-all duration-500 border-[0.5px] border-black/16 overflow-hidden outline-none!",
							isExpanded && "grow",
						)}
						onClick={() => {
