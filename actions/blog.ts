...
// Only use Payload if explicitly enabled
const USE_PAYLOAD = process.env.USE_PAYLOAD_DB === 'true'
...
export async function getAllPosts(
	...
	try {
		...
		console.error(
			"Failed to fetch posts from Payload, falling back to JSON:",
			error,
		)
...
export async function getPostBySlug(slug: string): Promise<Post | null> {
	...
	try {
		...
		console.error(
			"Failed to fetch post by slug from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getPostsByAuthor(authorId: string): Promise<Post[]> {
	...
	try {
		...
		console.error(
			"Failed to fetch posts by author from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getAllAuthors(): Promise<Author[]> {
	...
	try {
		...
		console.error(
			"Failed to fetch authors from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getAllCategories(): Promise<Category[]> {
	...
	try {
		...
		console.error(
			"Failed to fetch categories from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getCategoryBySlug(
	...
	try {
		...
		console.error(
			"Failed to fetch category by slug from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getPostsByCategory(slug: string): Promise<Post[]> {
	...
	try {
		...
		console.error(
			"Failed to fetch posts by category from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getAllTags(): Promise<Tag[]> {
	...
	try {
		...
		console.error(
			"Failed to fetch tags from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getTagBySlug(slug: string): Promise<Tag | null> {
	...
	try {
		...
		console.error(
			"Failed to fetch tag by slug from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
...
export async function getPostsByTag(slug: string): Promise<Post[]> {
	...
	try {
		...
		console.error(
			"Failed to fetch posts by tag from Payload, falling back to JSON:",
			error,
		)
		// Fallback to JSON if database query fails
		const data = await getBlogDataFromJSON()
